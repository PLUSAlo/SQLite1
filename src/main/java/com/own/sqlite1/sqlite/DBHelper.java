...
public class DBHelper extends SQLiteOpenHelper {
    ...
    interface Tables{
        ...
        String MOVIE = "movie";
        String SALE_HEADER= "sale_header";
        String ORDER_DETAIL = "order_detail";
        String SALE_DETAIL = "sale_detail";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(String.format(
                "CREATE TABLE %s(%s INTEGER PRIMARY KEY AUTOINCREMENT, " +
                        "%s TEXT UNIQUE NOT NULL, %s DATETIME NOT NULL," +
                        "%s INTEGER NOT NULL, %s TEXT NOT NULL %s, %s TEXT NOT NULL %s)",
                Tables.SALE_HEADER, BaseColumns._ID,
                Contract.SaleHeaders.ID,
        ...
        db.execSQL(String.format(
                ...
                References.ID_SALE_HEADER,
                Contract.SaleDetails.SEQUENCE,
                Contract.SaleDetails.SEQUENCE,
                Contract.SaleDetails.ID_PRODUCT,
                References.ID_PRODUCT,
                Contract.SaleDetails.QUANTITY,
                Contract.SaleDetails.ID,
                Contract.SaleDetails.SEQUENCE
        ));
        ...
        db.execSQL(String.format("CREATE TABLE %s (%s INTEGER PRIMARY KEY" +
                        " AUTOINCREMENT, %s TEXT NOT NULL UNIQUE, %s TEXT NOT NULL,%s TEXT NOT NULL, %s TEXT NOT NULL, " +
                        " %s INTEGER NOT NULL, %s INTEGER NOT NULL )",
                Tables.MOVIE, BaseColumns._ID,
                Contract.Movies.ID,
                Contract.Movies.NAME,
                Contract.Movies.DIRECTOR,
                Contract.Movies.CLASIFICATION,
                Contract.Movies.YEAR,
                Contract.Movies.DURATION));
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS "+Tables.SALE_HEADER);
        db.execSQL("DROP TABLE IF EXISTS "+Tables.SALE_DETAIL);
