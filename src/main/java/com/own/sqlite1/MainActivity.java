    ...
    public class DataTaskTest extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try{
                ...
                //Insert supplier
                String supplier1=data.insertSupplier(new Supplier(null,"Veronica","Del Topo","new"));
                String supplier2=data.insertSupplier(new Supplier(null,"Carlos","Villagran","old"));
                //Method
                ...
                //Cheaper Header
               /* String cheaper1=data.insertSaleHeader(new SaleHeader(null,supplier1,methodPayment1,currentDate));
                String cheaper2=data.insertSaleHeader(new SaleHeader(null,supplier2,methodPayment2,currentDate));


                //Cheaper detail
                data.insertSaleDetail(new SaleDetail(cheaper2,1,product1,5));
                data.insertSaleDetail(new SaleDetail(cheaper1,2,product1,15));
                data.insertSaleDetail(new SaleDetail(cheaper1,1,product1,35));
                data.insertSaleDetail(new SaleDetail(cheaper2,2,product1,45));
                   */
                //Order detail
            ...
            DatabaseUtils.dumpCursor(data.getOrderDetails());
            Log.d("SaleActivity Headers","SaleActivity Headers");
            DatabaseUtils.dumpCursor(data.getSaleDetails());
            Log.d("SaleActivity Details","SaleActivity Details");
            DatabaseUtils.dumpCursor(data.getSaleDetails());
